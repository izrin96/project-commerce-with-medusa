...
export default async function Footer() {
  ...
  return (
    <footer className="border-t border-gray-200 bg-white text-black dark:border-gray-700 dark:bg-black dark:text-white">
      <div className="mx-auto w-full max-w-7xl px-6">
        <div className="grid grid-cols-1 gap-8 border-b border-gray-200 py-12 transition-colors duration-150 dark:border-gray-700 lg:grid-cols-12">
